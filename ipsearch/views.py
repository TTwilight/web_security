...
def index(request):
    ...
    if ipaddress:
        ...
        baiduapi='http://api.map.baidu.com/staticimage/v2?ak=hNFf8i21Y8lPPlNbMXvt247DCIrtbDIR&center=116.403874,39.914888&width=300&height=200&zoom=11'
        ...
        time_zone=''
        ports=''
    return render(request,'ipsearch/index.html',{'ipadd' :ipaddress,'country':country,'address':address,'time_zone':time_zone,'ports':ports,'map':baiduapi})
